...
- [ ] **Step 1: Require the missing contract surfaces**
...
- [ ] **Step 3: Keep the RED assertions while implementing later tasks**
...
- [ ] **Step 1: Add opaque-ID artifact helpers to the contract**
...
- [ ] **Step 2: Implement dispatcher duplicate fixture modes**
...
- [ ] **Step 3: Run dispatcher duplicate proof and observe RED**
...
- [ ] **Step 4: Derive and report only safe dispatcher IDs in the role**
...
- [ ] **Step 5: Implement and prove the orthogonal rule duplicate scenario**
...
- [ ] **Step 1: Add the missing-proof RED assertion**
...
- [ ] **Step 2: Add surplus create/verify/removed modes**
...
- [ ] **Step 3: Integrate normal convergence cleanup**
...
- [ ] **Step 1: Add mixed and missing fixture/snapshot modes**
...
- [ ] **Step 2: Demonstrate mixed-drift check RED**
...
- [ ] **Step 3: Add seven planning categories without API mutation**
...
- [ ] **Step 4: Prove mixed-drift GREEN and normal repair**
...
- [ ] **Step 5: Prove missing-state POST planning GREEN**
...
- [ ] **Step 6: Integrate Mac mixed-drift acceptance**
...
- [ ] **Step 1: Run focused static and dynamic proofs**
...
- [ ] **Step 3: Run full Linux integration**
...
- [ ] **Step 4: Amend the commit and run fresh Mac lifecycle**
...
- [ ] **Step 5: Final cleanup and evidence**
...
- [ ] **Step 1: Write marker-count RED tests**
...
- [ ] **Step 2: Emit one marker per true predicate**
...
- [ ] **Step 3: Replace header assertions with exact counts**
...
- [ ] **Step 1: Write executable RED scenarios**
...
- [ ] **Step 2: Add a public fixed Dozzle refusal**
...
- [ ] **Step 3: Implement isolated verification and cleanup state machine**
...
- [ ] **Step 4: Run focused hook GREEN tests**
...
- [ ] **Step 1: Write diagnostic RED assertions**
...
- [ ] **Step 2: Replace raw diagnostics**
...
- [ ] **Step 3: Run full runtime acceptance and amend**
