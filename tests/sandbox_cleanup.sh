...
cleanup_sandbox_image=docker.io/library/python:3.14-alpine@sha256:c6ead215bfd31f1e433d968853b7a769989117115b728874824e6c0a27cb96fc
...
cleanup_sandbox_projects="$cleanup_sandbox_projects seerr seafile nextcloud"
...
cleanup_sandbox_seafile_services='seafile seafile-db seafile-cache'
...
cleanup_sandbox_project_services() {
  case $1 in
    ...
    seafile) cleanup_project_services=$cleanup_sandbox_seafile_services ;;
