...
# differently drops out of the filter while the glob still returns seventeen and
# the escaping assertion runs over nothing.
#
# Seventeen in the working tree and seventeen in the mutation sandbox, because
...
# seven services below today's count and clear of anything a collapse leaves.
