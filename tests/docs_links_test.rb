...
if ARGV == ["--self-test"]
  ...
  documentation_contracts = {
    "README.md" => {
      /manifest.*eighteen implemented service projects.*no planned (?:media-)?acquisition projects/im =>
        "distinguish the eighteen implemented service projects from the empty planned set",
