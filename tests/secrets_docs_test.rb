...
check(failures, vault_keys.length == 40,
      "vault example must contain exactly 40 vault_* keys (found #{vault_keys.length})")
...
start_and_recovery_guidance = [
  markdown_section(secrets_guide, "## Start here: choose fresh or migration"),
