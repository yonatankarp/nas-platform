...
check(failures, vault_keys.length == 67,
      "vault example must contain exactly 67 vault_* keys (found #{vault_keys.length})")
...
verify_tags = %w[
  ...
  platform_verify_arr platform_verify_downloaders platform_verify_bindery
  platform_verify_kapowarr platform_verify_pinchflat platform_verify_jellyfin
