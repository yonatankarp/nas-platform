...
# authenticated, read-only collections (no supported create/update/delete
# rule). Editing the PocketBase database is explicitly unsupported, and stopping real metrics
