...
mac_ansible_playbook -i "$mac_repo_dir/inventory/mac.yml" \
  ...
  --tags platform_verify_media_acquisition_foundation,platform_verify_ntfy,platform_verify_beszel,platform_verify_dozzle,platform_verify_audiobookshelf,platform_verify_komga,platform_verify_arr,platform_verify_downloaders,platform_verify_pinchflat,platform_verify_jellyfin,platform_verify_immich,platform_verify_paperless
