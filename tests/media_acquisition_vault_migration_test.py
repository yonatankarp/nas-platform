...
if mode == "duplicate-generated-api":
    ...
    patches.append(mock.patch.object(module.secrets, "token_urlsafe", return_value="same-password"))
elif mode == "encrypt":
...
class SyntheticRepository:
    ...
    def run(self, vault_argument="inventory/group_vars/all/vault.yml",
        ...
        result = subprocess.run(
            [sys.executable, "scripts/migrate-media-acquisition-vault.py",
    ...
    def inject(self, mode):
        ...
        self.assert_only_ciphertext_neighbors()
